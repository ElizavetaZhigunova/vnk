...
import { HiOutlineLocationMarker, HiMenuAlt2, HiSearch, HiOutlineHeart } from "react-icons/hi";
import { BsPerson } from "react-icons/bs";
import { AiOutlineShoppingCart } from "react-icons/ai";
import { MdOutlineLocalGasStation,MdMailOutline , MdOutlineAddToPhotos  , MdOutlineAgriculture, MdOutlineAssuredWorkload, MdApartment, MdOutlineDesignServices, MdFavoriteBorder    } from "react-icons/md";
...
const Category = ({ SwapPage }) => (<div className='category-cont'>
<div className='category-line'>
    ...
    <div className='category' onClick={() => SwapPage("SpecialTechnicsPage")}>
    ...
    <div className='category' onClick={() => SwapPage("ReadyBusinessPage")}>
...
export default function Header({ SwapPage }) {
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            setPlaceholder(width > 1224 ? 'Оптовые поставки нефти продуктов и удобрений' : 'Найти');
            ...
            <>
                <div className='Header-small'>
                    <div className='Header-small-top'>
                        ...
                        <img src={Logo} alt="Logo" className='logo-small' onClick={() => SwapPage("MainPage")} />
                        <div className='Icons-container' onClick={() => SwapPage("FranchisePage")}>
            ...
            <div className='HeaderCont'>
                ...
                <div className='Header'>
                    {(isWideScreen && isAdvVisible) && 
                        <div className='Header-container-up'>
                            ...
                            <div className='SecondLink'>
                                <p onClick={() => SwapPage("FranchisePage")}>Франшиза</p>
                                <p>Инвестиции</p>
                    ...
                    <div className='Header-container-dawn'>
                        <div className='Logo'>
                            <img src={Logo} alt="Logo" onClick={() => SwapPage("MainPage")} />
                            <button>
                                <HiMenuAlt2 />
                                {isWideScreen && ' Каталог'}
                            </button>
